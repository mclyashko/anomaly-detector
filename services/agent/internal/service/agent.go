...
// NewAgentService creates an AgentService — a service that periodically collects metrics
// from all collectors and sends batches to ingestion (via Kafka or HTTP).
// agentID uniquely identifies this instance.
